...
with Ada.Text_IO; -- makes the Ada.Text_IO package available for use in this procedure, no equivalent in Java
...
procedure Hello is -- DON'T forget 'is'. Declarations are between 'is' and 'begin'. No main() function is needed
...
end hello; -- the 'end' may optionally follow by the procedure name (note, not case sensitive)
